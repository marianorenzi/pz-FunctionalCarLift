...
function ISVehicleMechanics:onListRightMouseUp(x,y)
  print("[FunctionalCarLift] onListRightMouseUp for vehicle: "..self.parent.vehicle:getScript():getName()..' ('..tostring(self.parent.vehicle)..')')
...
function ISVehicleMechanics:doPartContextMenu(part,x,y)
  print("[FunctionalCarLift] doPartContextMenu for vehicle: "..self.vehicle:getScript():getName()..' ('..tostring(self.vehicle)..')')
...
function ISVehicleMechanics:onRightMouseUp(x, y)
  print("[FunctionalCarLift] onRightMouseUp for vehicle: "..self.vehicle:getScript():getName()..' ('..tostring(self.vehicle)..')')
  CheckCarLiftNearby(self.vehicle)
